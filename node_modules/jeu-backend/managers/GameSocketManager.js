    ...
    surrenderOnline(params) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.gh.getGame(this.socket.gameID).then((game) => {
                ...
                this.DBConnection.addMatch({"winner": winner, "loser": surrendered_player_id, "remaining_hp": winner.hp, "type": "online"})
                
                this.socket.emit("surrenderedOnline");
              ...
              console.log("Match non trouvé dans classe");  
            });
