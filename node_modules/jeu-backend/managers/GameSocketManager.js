...
class GameSearchSocketManager {
    ...
    launchNewTurn(arme_posee) {
        console.log("Appel launch new turn");
        let cur_player;
                ...
                if(game.estEnCombat()) {
                    ...
                    if(prev_player.pv === 0) {
                        ...
                        if(!game.local) {
                            ...
                            this.DBConnection.addMatch({"player1": winner.online_id, "player2": loser.online_id, "type": "online", "winner": winner.online_id, "remaining_hp": winner.pv}); // On envoie les données de partie au serveur, mis online pour le moment    
                        }
