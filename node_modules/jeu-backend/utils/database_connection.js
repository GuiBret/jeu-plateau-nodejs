    ...
    */
    getUserData(params) {
        ...
        return new Promise((resolve, reject) => {
           ...
           this.db_connection.query(`SELECT * from connexion where username='${params["username"]}'`, (err, results) => {
               if(err) {                   
                   console.log(err);
                   reject(err);
               }
    ...
    createUser(userInfo) {
        ...
        return new Promise((resolve, reject) => {
           this.db_connection.query(`INSERT INTO connexion VALUES ('', '${userInfo.username}', '${userInfo.password}', '')`, (err, results) => {
               ...
               this.db_connection.query(`SELECT id from connexion where username="${userInfo.username}"`, (err, result) => { // We ask the database the new user's id so that we can store it in sessionStorage
    ...
    getOptions(id) {
        console.log("Passage dans getOptions");
        console.log(id);
        return new Promise((resolve, reject) => {
            console.log("Meuh");
    ...
    removeUser(username) { // Utility function, testing purposes only (for now)
