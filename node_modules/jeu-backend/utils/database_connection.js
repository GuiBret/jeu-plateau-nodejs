...
class DatabaseConnection {
    ...
    */
    ...
    generateSetOptionsQuery(info) {
        return `UPDATE options set animations=${info.animations}, volume=${info.volume} where joueur_concerne=${info.joueur_concerne}`;
    }
    
    generateCreateOptionsQuery(id) {
        return `INSERT INTO options VALUES ('', ${id}, 1, .5)`;
    }
}
